...
// 2. IMPORTANTE: Use o Namespace correto aqui
use Models\Visitantes;

try {
    // Como o seu Model já cria a conexão no construtor dele (new Database),
    // você só precisa instanciar a classe com o namespace.
