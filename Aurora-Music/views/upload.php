...
<head>
    ...
    <link rel="stylesheet" href="/Aurora-Music/assets/css/upload.css">
</head>
<body>
    <div class="page-wrapper">
        <div class="header">
            ...
            <div class="user-actions" style="display: flex; gap: 10px; align-items: center;">
                <a href="/Aurora-Music/dashboard" class="btn-secondary">Voltar ao Menu</a>
                <a href="/Aurora-Music/logout" class="btn-logout-top">Sair</a>
            </div>
        </div>
        <div class="container">
            <div class="card">
    ...
    <script src="/Aurora-Music/assets/js/upload.js"></script>
</body>
</html>