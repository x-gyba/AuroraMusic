        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li class="nav-item"><a href="/Aurora-Music/upload" class="nav-link"><i class="fas fa-compact-disc"></i> <span>Cadastro de Músicas</span></a></li>
                    ...
                    <li class="nav-item"><a href="/Aurora-Music/logout" class="nav-link danger"><i class="fas fa-sign-out-alt"></i> <span>Sair</span></a></li>
                </ul>
            </nav>
        </aside>
            ...
            <section class="content-section active" id="home">
                ...
                <div class="cards-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-info"><h3>Acessos Total</h3><p><?php echo $visitantesTotal; ?></p></div>
                    </div>
                    <div class="stat-card">
            ...
            <section class="content-section" id="publicidade">
                <div class="content-card">
                    ...
                    <form id="formUploadPromo" enctype="multipart/form-data" style="margin: 20px 0;">
                        ...
                        <button type="submit" id="btnSubirPromo" class="btn btn-primary"><i class="fas fa-upload"></i> Enviar Propaganda</button>
                        ...
                        if (is_dir($promoDir)) {
                            ...
                            foreach ($files as $file) {
                                if (pathinfo($file, PATHINFO_EXTENSION) === 'mp3') {
                                    ...
                                    echo "<li style='display:flex; justify-content:space-between; align-items:center; padding:10px; border-bottom:1px solid #eee; " . ($isPromo ? "background:#fff9db;" : "") . "'>
                                            <span><i class='fas " . ($isPromo ? "fa-star' style='color:#f59e0b" : "fa-file-audio") . "'></i> $file</span>
                                            " . (!$isPromo ? "<button class='btn-delete-promo' data-filename='$file' style='background:none; border:none; color:#ef4444; cursor:pointer;'><i class='bx bx-trash' style='font-size:1.3rem;'></i></button>" : "") . "
                                          </li>";
                                }
                            }
                        }
            ...
            <section class="content-section" id="orfaos">
                <div class="content-card">
                    ...
                    <div class="orphan-actions">
                        <button class="btn btn-primary" id="btnVerificarOrfaos"><i class="fas fa-search"></i> Verificar</button>
                        <button class="btn btn-danger" id="btnLimparOrfaos" disabled><i class="fas fa-trash-alt"></i> Limpar Órfãos</button>
                    </div>
