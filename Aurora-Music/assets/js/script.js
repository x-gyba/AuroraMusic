...
const player = {
    ...
    deletePromo(file) {
        ...
        // Ajustado para caminho absoluto para não dar 404 no dashboard
        fetch('/Aurora-Music/views/delete-promo.php', {
            method: 'POST',
            body: fd
        })
        .then(r => r.json())
    ...
    async loadPromos() {
        try {
            // Ajustado para caminho absoluto fixo
            const response = await fetch('/Aurora-Music/controllers/get_promos.php');
    ...
    async playPromo() {
        ...
        if (this.albumCover) this.albumCover.src = '/Aurora-Music/assets/images/promo-cover.png';
