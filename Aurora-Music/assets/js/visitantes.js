...
async function carregarGrafico(inicio, fim) {
    try {
        const response = await fetch(`/Aurora-Music/controllers/visitantes_controller.php?action=grafico&inicio=${inicio}&fim=${fim}`);
...
async function carregarCards(dataInicio, dataFim, pagina) {
    ...
    try {
        ...
        const response = await fetch(`/Aurora-Music/controllers/visitantes_controller.php?${params}`);
        const data = await response.json();
...
async function excluirRegistro(id) {
    ...
    try {
        const response = await fetch('/Aurora-Music/controllers/visitantes_controller.php', {
            method: 'POST',
